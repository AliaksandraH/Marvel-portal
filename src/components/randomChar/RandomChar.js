...
const View = ({char}) => {
    ...
    const desc = !description ? 'There is no description for this character' : description.slice(0, 170) + '...';
    ...
    return (
        <div className="randomchar__block">
            <img src={thumbnail} alt="Random character" className="randomchar__img" style={classForImg}/>
